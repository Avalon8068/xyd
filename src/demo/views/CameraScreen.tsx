...
import {StyleSheet, Text, View, TouchableOpacity, Slider, TouchableWithoutFeedback, Dimensions} from 'react-native';
    ...
    return (
      <RNCamera
        ...
        faceDetectionLandmarks={
          RNCamera.Constants.FaceDetection.Landmarks ? RNCamera.Constants.FaceDetection.Landmarks.all : undefined
        }
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity onPress={this.toggle('canDetectFaces')} style={styles.flipButton}>
              <Text style={styles.flipText}>{!canDetectFaces ? 'Detect Faces' : 'Detecting Faces'}</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity onPress={this.toggle('canDetectBarcode')} style={styles.flipButton}>
              <Text style={styles.flipText}>{!canDetectBarcode ? 'Detect Barcode' : 'Detecting Barcode'}</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={{bottom: 0}}>
          ...
          {this.state.zoom !== 0 && <Text style={[styles.flipText, styles.zoomText]}>Zoom: {this.state.zoom}</Text>}
          <View
            style={{
              height: 56,
              backgroundColor: 'transparent',
