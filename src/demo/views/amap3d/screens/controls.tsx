  ...
  return (
    <>
      ...
      <View style={{flexDirection: 'row', backgroundColor: colors.background}}>
        ...
        <SwitchWithLabel label="比例尺" value={scaleControlsEnabled} onChange={setScaleControlsEnabled} />
        <SwitchWithLabel label="缩放控件" value={zoomControlsEnabled} onChange={setZoomControlsEnabled} />
        <SwitchWithLabel label="定位按钮" value={myLocationButtonEnabled} onChange={setMyLocationButtonEnabled} />
      </View>
    </>
  );
};
