  ...
  return (
    <>
      ...
      <View style={{flexDirection: 'row', backgroundColor: colors.background}}>
        <SwitchWithLabel label="缩放" value={zoomGesturesEnabled} onChange={setZoomGesturesEnabled} />
        <SwitchWithLabel label="滑动" value={scrollGesturesEnabled} onChange={setScrollGesturesEnabled} />
        <SwitchWithLabel label="旋转" value={rotateGesturesEnabled} onChange={setRotateGesturesEnabled} />
        <SwitchWithLabel label="倾斜" value={tiltGesturesEnabled} onChange={setTiltGesturesEnabled} />
      </View>
    </>
  );
};
